...
## Recent Accomplishments (Beyond Thesis Scope)
...
### 2. **Fragment Page Value Discovery** ([`Periodic_Frag_and_EE_kicked_Ising_chain.ipynb`](./Periodic_Frag_and_EE_kicked_Ising_chain.ipynb))
